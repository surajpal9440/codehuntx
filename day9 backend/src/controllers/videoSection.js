...
const generateUploadSignature = async (req, res) => {
  try {
    ...
    // Verify problem exists IF problemId is provided (not 'new' or 'temp')
    ...
    const folder = (problemId && problemId !== 'new') ? problemId : 'temp_uploads';
    const publicId = `leetcode-solutions/${folder}/${userId}_${timestamp}`;
