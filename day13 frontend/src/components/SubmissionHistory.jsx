...
// 🚀 FIX: Accept a new prop 'refreshTrigger' to enable external refresh
const SubmissionHistory = ({ problemId, refreshTrigger }) => { 
    ...
    useEffect(() => {
        const fetchSubmissions = async () => {
            try {
                setLoading(true);
                // 🚀 NOTE: Assuming the correct endpoint is /submission/submittedProblem/:problemId 
                const response = await axiosClient.get(`problem/submittedProblem/${problemId}`); 
                
                // Sort by date/time descending to show latest first
        ...
        // 🚀 FIX: Added refreshTrigger to the dependency array. 
        // Whenever ProblemPage changes this value (e.g., after a successful submit), 
        // this effect will rerun and fetch the new list.
        fetchSubmissions();
    }, [problemId, refreshTrigger]); // 🚀 CHANGE: Added refreshTrigger here
                ...
                <div className="modal modal-open">
                    <div className="modal-box w-11/12 max-w-5xl">
                        ...
                        <div className="mb-4">
                            ...
                            {/* 🚀 FIX: Check for errorMessage before trying to render */}
                            {selectedSubmission.errorMessage && selectedSubmission.status === 'error' && (
